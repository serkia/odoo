(function () {
    ...
    website.if_dom_contains('#email_designer', function () {
        website.snippet.BuildingBlock.include({
            start: function() {
                ...
                this.$button.trigger( "click" ).css("display", "none");
            },
            _get_snippet_url: function () {
                ...
                if(url_data.hasOwnProperty('theme_id')){
            ...
            show_blocks: function () {
                this._super.apply(this, arguments);
                $('div#wrapwrap').css('margin-top' , '102px');
                $( "div.navbar-static-top" ).css({ 'position' : 'fixed', 'width' : '100%'});
                $('div#wrap').css('margin-top' , '40px');
            },
            hide: function () {},
        });
    });
    ...
    openerp.jsonRpc('/web/dataset/call', 'call', {
        ...
        'args': ['website_mail.dialog_email_template_theme', openerp.website.get_context()]
    }).done(function (data) {
    ...
    openerp.website.EmailTemplateTheme = openerp.Widget.extend({
        ...
        events: {
            'click .close': 'close',
            'click .template_thumbnail div .btn': 'select_template',
        },
        start: function () {
            var self= this;

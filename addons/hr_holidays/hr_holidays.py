...
class hr_employee(osv.Model):
    ...
    def _search_absent_employee(self, cr, uid, obj, name, args, context=None):
        ...
        for holiday in holiday_ids:
            absent_emp_ids.append(holiday['employee_id'][0])
    ...
    _columns = {
        ...
        'absent_of_today': fields.function(lambda *x: {}, fnct_search=_search_absent_employee, type="boolean", string="Absent Today")
    }

...
instance.web_gantt.GanttView = instance.web.View.extend({
    ...
    init: function() {
        ...
        gantt.config.columns = [{name:"text", label:"Gantt View", tree:true, width:'*' }];
    ...
    do_search: function (domains, contexts, group_bys) {
        ...
        if(this.fields_view.arch.attrs.colors) {
            this.colors = _(this.fields_view.arch.attrs.colors.split(';')).chain().compact().map(function(color_pair) {
                ...
                fields.push(temp.expressions[0].value);
    ...
    on_data_loaded_2: function(tasks, group_bys) {
        ...
        $("input[value=" + scale + "]").prop("checked", true);
        self.scale_zoom(scale);
        gantt.init(this.chart_id);
        gantt.clearAll();
        $(".oe_gantt_button_create").unbind("click");
        ...
        gantt.templates.tooltip_text = function(start, end, task) {
            ...
            return "<b><u>" + task.text + "</u></b><br/><b>Start date:</b> " + start.format('d-m-Y') + "<br/><b>End date:</b> " + end.format('d-m-Y') + "<br/><b>Duration:</b> " + duration.toFixed(2) + " Hours";
        };
        ...
        $("input[name='scale']", this.$el).click(function(e) {
            self.scale_zoom(e.target.value);
            gantt.parse({"data": tasks});
        });
    },
    ...
    on_task_changed: function(task_obj) {
        ...
        var end = gantt.calculateEndDate(start, duration, "hour");
        var data = {};

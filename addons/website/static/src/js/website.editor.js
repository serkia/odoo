(function () {
    ...
    */
    ...
    function is_editable_node(element) {
        return (!_.isUndefined(element.data('oe-model')) && element.data('oe-model') != 'ir.ui.view') 
    ...
    website.EditorBar = openerp.Widget.extend({
         ...
         */
        setup_hover_buttons: function (e) {
            var editor = $('.note-air-editor');
    ...
    website.summernote.eventHandler = openerp.Widget.extend({
        ...
        hMouseover : function (event) {
            var self = this;
            if(is_editable_node($(event.target))) { $(event.target).addClass('note-wrapper-editable'); return;}
        },

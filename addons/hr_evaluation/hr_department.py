...
class hr_department(models.Model):
    ...
    appraisal_to_start_count = fields.Integer(compute='_appraisal_to_start_count', string='Appraisal to Start')
    interview_request_count = fields.Integer(compute='_interview_request_count', string='Interview Request')

        ...
        cr.execute("""
            create or replace view report_pos_order as (
                select
                    ...
                    ((sum(l.qty*l.price_unit)/sum(l.qty * u.factor)) / cr.rate)::decimal(16,2) as average_price,
                ...
                group by
                    ...
                    s.user_id,s.location_id,s.company_id,s.sale_journal,l.product_id,s.create_date,cr.rate
                having

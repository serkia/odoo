...
class hr_employee(osv.Model):
    ...
    def _search_newly_hired_employee(self, cr, uid, obj, name, args, context=None):
        ...
        for applicant in applicant_ids:
            if applicant['emp_id']:
                hired_emp_ids.append(applicant['emp_id'][0])
        return [('id', 'in', hired_emp_ids)]

    _columns = {
        'newly_hired_employee': fields.function(lambda *x: {}, fnct_search=_search_newly_hired_employee, type='boolean', string='Newly hired employees')
    }

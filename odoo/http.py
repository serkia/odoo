...
def dispatch_rpc(service_name, method, params):
    ...
    try:
        ...
        return result
    except (odoo.osv.orm.except_orm, odoo.exceptions.AccessError, \
            odoo.exceptions.AccessDenied, odoo.exceptions.Warning, \
...
class WebRequest(object):
    ...
    def registry(self):
        ...
        """
        return odoo.modules.registry.RegistryManager.get(self.db) if self.db else None
...
def serialize_exception(e):
    ...
    if isinstance(e, odoo.osv.osv.except_osv):
            ...
            with request:
                ...
                if db:
                    ...
                    try:
                        ...
                        odoo.modules.registry.RegistryManager.signal_caches_change(db)
                else:
                    result = _dispatch_nodb()
...
root = Root()
odoo.service.wsgi_server.register_wsgi_handler(root)

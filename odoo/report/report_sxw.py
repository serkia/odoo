...
from odoo.osv.fields import float as float_field, function as function_field, datetime as datetime_field
...
class rml_parse(object):
    def __init__(self, cr, uid, name, parents=rml_parents, tag=rml_tag, context=None):
        ...
        self.cr = cr
        self.uid = uid
        self.pool = odoo.registry(cr.dbname)
...
class report_sxw(report_rml, preprocess.report):
    ...
    def getObjects(self, cr, uid, ids, context):
        table_obj = odoo.registry(cr.dbname)[self.table]

...
class configmanager(object):
    def __init__(self, fname=None):
        ...
        group.add_option('--debug-werkzeug', action="append_const", dest="log_handler", const="werkzeug:DEBUG", help='Werkzeug debug mode. shortcut for --log-handler=werkzeug:DEBUG')
